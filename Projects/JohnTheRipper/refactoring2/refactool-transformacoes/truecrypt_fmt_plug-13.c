...
int var048c456ddc1c4619bbac44f33ad63e10 = 1;
#ifdef _OPENMP#pragma omp parallel for#endiffor(i = 0; i < count; i+=psalt->loop_inc){unsigned char key[64];#if SSE_GROUP_SZ_SHA512unsigned char Keys[SSE_GROUP_SZ_SHA512][64];#endifint j;int ksz = strlen((char *)key_buffer[i]);#if SSE_GROUP_SZ_SHA512
		var048c456ddc1c4619bbac44f33ad63e10 =  (psalt->hash_type != IS_SHA512);
#endif
if (var048c456ddc1c4619bbac44f33ad63e10) {
